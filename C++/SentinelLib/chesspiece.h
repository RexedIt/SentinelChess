...
namespace chess
{
    ...
    private:
        ...
        void rook_moves(std::vector<move_s> &possible, coord_s p0, unsigned char (&cells)[8][8]);
        void queen_moves(std::vector<move_s> &possible, coord_s p0, unsigned char (&cells)[8][8]);
        void king_moves(std::vector<move_s> &possible, coord_s p0, unsigned char (&cells)[8][8], unsigned char castled_left, unsigned char castled_right);
        ...
        void possible_pawn_move(std::vector<move_s> &possible, coord_s p0, int8_t dy, int8_t dx);
    };
