...
namespace chess
{
    ...
    public:
        chessplayerdata();
        chessplayerdata(std::string _guid, std::string _username, int32_t _elo, chessplayertype_e _playertype, bool _persistent, std::string _meta, int32_t _puzzlepoints = 0);
